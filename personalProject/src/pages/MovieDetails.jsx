...
const MovieDetails = () => {
  ...
  const {axios
    , getToken,shows, 
    favouriteMovies,fetchFavouriteMovies, image_base_url,user} = useAppContext();
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
     ...
     <div className='flex flex-wrap max-sm:justify-center gap-8'>
      ...
      <div className="flex justify-center mt-20">
        <button onClick={()=>{navigate('/movie'); scrollTo(0,0) } }className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer'>Show More</button>
      </div>
