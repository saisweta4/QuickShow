    ...
    <>
      ...
      <div className="group flex flex-wrap gap-4 mt-4 w-max">
        {nowPlayingMovies.map((movie)=>(
          <div key={movie.id} onClick={() => setSelectedMovie(movie.id)} className={`relative max-w-40 cursor-pointer group-hover:opacity-40 hover:!opacity-100 hover:-translate-y-1 transition duration-300`}>
